...
function handleApproveRequest(request: BudgetRequest) {
  if (
    confirm(`Approve budget request ${request.id} for $${request.requested_budget_usd.toFixed(2)}?`)
  ) {
...
<template>
  <div>
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
      <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Budget Requests</h1>
      <Button
      ...
      >
        ...
        <TabsContent value="my-requests">
          ...
          >
            ...
            <Button @click="showCreateModal = true"> Create First Request </Button>
          </div>
        </TabsContent>
        ...
        <div class="space-y-4 py-4">
          ...
          <div class="space-y-2">
            ...
            <Input
              ...
              :disabled="createMutation.isPending.value"
            />
            <p class="text-xs text-gray-500">Maximum: $10,000</p>
          </div>
          ...
          <div class="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span class="ml-2 font-medium"
                >${{ rejectingRequest.requested_budget_usd.toFixed(2) }}</span
              >
            </div>
          </div>
