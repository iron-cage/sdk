...
def _load_config():
    """
    Searches for the 'secret' folder and '-secret.sh' file 
    ...
    while True:
        # Construct the path: current_dir/secret/-secret.sh
        secret_file = os.path.join(current_path, "secret", "-secret.sh")
        ...
        if parent == current_path: 
            print("WARNING: Config file 'secret/-secret.sh' not found in any parent directory!")
            return False
