...
| `analytics/`            | Handles analytics data endpoints (Protocol 012)                                           |
| `auth/`                 | Handles authentication endpoints (Protocol 007)                                           |
| `budget/`               | Handles budget control endpoints (Protocol 005)                                           |
| `freeform.rs`           | FreeForm onboarding endpoints: parse + upsert company, apply provider keys (Task 029)     |
...
| `invites.rs`            | Invite link endpoints: generate, preview, accept, approve invite seats (Task 029)         |
...
| `tokens/`               | Handles API token management endpoints                                                    |
...
| `workspace.rs`          | Workspace management endpoints: upsert spending policy, read current workspace (Task 029) |
