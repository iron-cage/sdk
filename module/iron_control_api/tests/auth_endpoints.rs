...
fn test_jwt_secret_creation() {
  ...
  let token = secret
    .generate_access_token("user_123", "user@mail.com", "a", "token_id_001")
...
fn test_access_token_lifecycle() {
  ...
  let token = secret
    .generate_access_token("user_123", "user@mail.com", "b", "token_id_001")
...
fn test_login_flow_concept() {
  ...
  let access_token = secret
    .generate_access_token(user_id, "user@mail.com", "c", "token_id_001")
    .expect("LOUD FAILURE: Should generate");
...
fn test_token_refresh_flow_concept() {
  ...
  let new_access_token = secret
    .generate_access_token(user_id, "user@mail.com", "c", "token_id_002")
    .expect("LOUD FAILURE: Should generate");
