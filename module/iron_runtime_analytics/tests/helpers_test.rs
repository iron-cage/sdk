...
fn test_infer_provider_anthropic_claude3() {
  assert_eq!(
    infer_provider("claude-3-opus-20240229"),
    Provider::Anthropic
  );
  assert_eq!(
    infer_provider("claude-3-sonnet-20240229"),
    Provider::Anthropic
  );
  assert_eq!(
    infer_provider("claude-3-haiku-20240307"),
    Provider::Anthropic
  );
  assert_eq!(
    infer_provider("claude-3-5-sonnet-20241022"),
    Provider::Anthropic
  );
}
