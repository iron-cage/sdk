# Iron Control Schema - Specification

**Module:** iron_control_schema
...
PostgreSQL schema for Iron Cage Control Panel in production deployment mode. This is separate from iron_runtime_state (SQLite, local agent execution) and handles centralized cloud data.

**Key Difference from iron_runtime_state:**
- iron_runtime_state: SQLite, local per-machine, agent execution state
- iron_control_schema: PostgreSQL, centralized cloud, user/token/secret data
...
**Phase 1 (Q1 2026):**
- Create sqlx migrations in `module/iron_control_schema/migrations/`
