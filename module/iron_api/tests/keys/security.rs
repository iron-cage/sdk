...
use iron_api::routes::keys::{ KeysState, get_key, KeyResponse };
...
/// Create test router with very low rate limit for testing.
///
/// Uses rate limit of 2 requests per 60 seconds to easily trigger rate limiting.
async fn create_rate_limited_router() -> Router
{
