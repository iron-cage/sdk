...
mod implementation
{
  ...
  pub struct ApiState
  {
    pub state_manager: Arc<iron_state::StateManager>,
  }
  ...
  impl ApiServer
  {
    ...
    pub fn new(state_manager: Arc<iron_state::StateManager>, port: u16) -> Self
    {
  ...
  ) -> impl IntoResponse
  {
    ...
    {
      agent_state.status = iron_state::AgentStatus::Stopped;
