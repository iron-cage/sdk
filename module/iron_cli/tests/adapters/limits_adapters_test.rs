...
async fn test_list_limits_adapter_success() {
  ...
  let result = iron_cli::adapters::limits::list_limits_adapter(&command, adapter, &formatter).await;
...
async fn test_list_limits_adapter_json_format() {
  ...
  let command = create_verified_command(".limits.list", &[("format", "json")]);
...
async fn test_get_limit_adapter_success() {
  ...
  let command = create_verified_command(".limits.get", &[("limit_id", "lim_api_requests")]);

  let result = iron_cli::adapters::limits::get_limit_adapter(&command, adapter, &formatter).await;
...
async fn test_get_limit_adapter_not_found() {
  ...
  let command = create_verified_command(".limits.get", &[("limit_id", "nonexistent")]);
...
async fn test_get_limit_adapter_empty_limit_id() {
  ...
  let command = create_verified_command(".limits.get", &[("limit_id", "")]);
...
async fn test_get_limit_adapter_all_formats() {
  ...
  for format_str in formats {
    ...
    let command = create_verified_command(
      ".limits.get",
      &[("limit_id", "lim_api_requests"), ("format", format_str)],
    );
...
async fn test_create_limit_adapter_success() {
  ...
  let command = create_verified_command(
    ".limits.create",
    &[("resource_type", "api_calls"), ("limit_value", "5000")],
  );

  let result =
    iron_cli::adapters::limits::create_limit_adapter(&command, adapter.clone(), &formatter).await;
...
async fn test_create_limit_adapter_missing_resource_type() {
  ...
  let command = create_verified_command(".limits.create", &[("limit_value", "1000")]);

  let result =
    iron_cli::adapters::limits::create_limit_adapter(&command, adapter, &formatter).await;
...
async fn test_create_limit_adapter_missing_limit_value() {
  ...
  let command = create_verified_command(".limits.create", &[("resource_type", "api_calls")]);
...
async fn test_create_limit_adapter_invalid_limit_value() {
  ...
  let command = create_verified_command(
    ".limits.create",
    &[("resource_type", "api_calls"), ("limit_value", "invalid")],
  );
...
async fn test_create_limit_adapter_negative_value() {
  ...
  let command = create_verified_command(
    ".limits.create",
    &[("resource_type", "api_calls"), ("limit_value", "-100")],
  );
...
async fn test_update_limit_adapter_success() {
  ...
  let command = create_verified_command(
    ".limits.update",
    &[("limit_id", "lim_api_requests"), ("limit_value", "2000")],
  );

  let result =
    iron_cli::adapters::limits::update_limit_adapter(&command, adapter, &formatter).await;
...
async fn test_update_limit_adapter_missing_limit_id() {
  ...
  let command = create_verified_command(".limits.update", &[("limit_value", "2000")]);
...
async fn test_update_limit_adapter_missing_limit_value() {
  ...
  let command = create_verified_command(".limits.update", &[("limit_id", "lim_api_requests")]);
...
async fn test_update_limit_adapter_not_found() {
  ...
  let command = create_verified_command(
    ".limits.update",
    &[("limit_id", "nonexistent"), ("limit_value", "2000")],
  );
...
async fn test_update_limit_adapter_invalid_value() {
  ...
  let command = create_verified_command(
    ".limits.update",
    &[("limit_id", "lim_api_requests"), ("limit_value", "invalid")],
  );
...
async fn test_delete_limit_adapter_success() {
  ...
  let command = create_verified_command(".limits.delete", &[("limit_id", "lim_api_requests")]);

  let result =
    iron_cli::adapters::limits::delete_limit_adapter(&command, adapter.clone(), &formatter).await;
...
async fn test_delete_limit_adapter_missing_limit_id() {
  ...
  let result =
    iron_cli::adapters::limits::delete_limit_adapter(&command, adapter, &formatter).await;
...
async fn test_delete_limit_adapter_empty_limit_id() {
  ...
  let command = create_verified_command(".limits.delete", &[("limit_id", "")]);
...
async fn test_delete_limit_adapter_not_found() {
  ...
  let command = create_verified_command(".limits.delete", &[("limit_id", "nonexistent")]);
...
async fn test_delete_limit_adapter_confirmation() {
  ...
  let command = create_verified_command(".limits.delete", &[("limit_id", "lim_storage_gb")]);
