...
fn get_api_endpoints() -> Vec<ApiEndpoint> {
  vec![
    ...
    ApiEndpoint {
      method: "GET",
      path: "/api/usage/aggregate",
      category: "usage",
      operation: "aggregate",
    },
    ApiEndpoint {
      method: "GET",
      path: "/api/usage/by-project/{id}",
      category: "usage",
      operation: "by-project",
    },
    ApiEndpoint {
      method: "GET",
      path: "/api/usage/by-provider/{provider}",
      category: "usage",
...
fn get_cli_commands() -> Vec<CliCommand> {
  vec![
    ...
    CliCommand {
      command: "iron-token auth login",
      category: "auth",
      operation: "login",
      api_endpoint: "POST /api/auth/login",
    },
    CliCommand {
      command: "iron-token auth refresh",
      category: "auth",
      operation: "refresh",
      api_endpoint: "POST /api/auth/refresh",
    },
    CliCommand {
      command: "iron-token auth logout",
      category: "auth",
      operation: "logout",
      api_endpoint: "POST /api/auth/logout",
    },
    // Token management commands (5)
    CliCommand {
      command: "iron-token tokens generate",
      category: "tokens",
      operation: "create",
      api_endpoint: "POST /api/tokens",
    },
    CliCommand {
      command: "iron-token tokens list",
      category: "tokens",
      operation: "list",
      api_endpoint: "GET /api/tokens",
    },
    CliCommand {
      command: "iron-token tokens get",
      category: "tokens",
      operation: "get",
      api_endpoint: "GET /api/tokens/{id}",
    },
    CliCommand {
      command: "iron-token tokens rotate",
      category: "tokens",
      operation: "rotate",
      api_endpoint: "POST /api/tokens/{id}/rotate",
    },
    CliCommand {
      command: "iron-token tokens revoke",
      category: "tokens",
      operation: "revoke",
      api_endpoint: "POST /api/tokens/{id}/revoke",
    },
    // Usage analytics commands (4 - includes export which aggregates API calls)
    CliCommand {
      command: "iron-token usage show",
      category: "usage",
      operation: "aggregate",
      api_endpoint: "GET /api/usage/aggregate",
    },
    CliCommand {
      command: "iron-token usage by-project",
      category: "usage",
      operation: "by-project",
      api_endpoint: "GET /api/usage/by-project/{id}",
    },
    CliCommand {
      command: "iron-token usage by-provider",
      category: "usage",
      operation: "by-provider",
      api_endpoint: "GET /api/usage/by-provider/{provider}",
    },
    CliCommand {
    ...
    CliCommand {
      command: "iron-token limits list",
      category: "limits",
      operation: "list",
      api_endpoint: "GET /api/limits",
    },
    CliCommand {
      command: "iron-token limits get",
      category: "limits",
      operation: "get",
      api_endpoint: "GET /api/limits/{id}",
    },
    CliCommand {
      command: "iron-token limits create",
      category: "limits",
      operation: "create",
      api_endpoint: "POST /api/limits",
    },
    CliCommand {
      command: "iron-token limits update",
      category: "limits",
      operation: "update",
      api_endpoint: "PUT /api/limits/{id}",
    },
    CliCommand {
      command: "iron-token limits delete",
      category: "limits",
      operation: "delete",
      api_endpoint: "DELETE /api/limits/{id}",
    },
    // Traces commands (3 - includes export)
    CliCommand {
      command: "iron-token traces list",
      category: "traces",
      operation: "list",
      api_endpoint: "GET /api/traces",
    },
    CliCommand {
      command: "iron-token traces get",
      category: "traces",
      operation: "get",
      api_endpoint: "GET /api/traces/{id}",
    },
    CliCommand {
      command: "iron-token traces export",
      category: "traces",
      operation: "list",
      api_endpoint: "GET /api/traces",
    },
    // Health command (1)
    CliCommand {
      command: "iron-token health",
      category: "health",
      operation: "check",
      api_endpoint: "GET /api/health",
    },
  ]
}
...
fn test_count_parity() {
  ...
  println!(
    "\n✓ Count parity verified: {} API endpoints = {} unique CLI commands",
    api_endpoints.len(),
    cli_counts.values().sum::<i32>()
  );
}
...
fn test_operation_parity() {
  ...
  println!(
    "\n✓ Operation parity verified: {} operations have CLI/API parity",
    api_operations.len()
  );
}
...
fn test_command_structure_parity() {
  ...
  for command in &cli_commands {
    ...
    assert_eq!(
      parts[0], "iron-token",
      "Command must start with 'iron-token'"
    );
...
fn test_api_coverage() {
  ...
  println!(
    "\n✓ API coverage verified: All {} API endpoints have CLI commands",
    api_endpoints.len()
  );
}
...
fn test_category_completeness() {
  ...
  println!(
    "\n✓ Category completeness verified: All {} categories present in API and CLI",
