...
fn route_to_handler(
  ...
  match command_name {
    ...
    ".agent.assign_providers" => runtime
      .block_on(iron_cli::adapters::control::agent_adapters::assign_providers_adapter(params)),
    ".agent.list_providers" => runtime
      .block_on(iron_cli::adapters::control::agent_adapters::list_agent_providers_adapter(params)),
    ".agent.remove_provider" => {
      runtime.block_on(iron_cli::adapters::control::agent_adapters::remove_provider_adapter(params))
    }
    ".agent.ic_token.generate" => runtime
      .block_on(iron_cli::adapters::control::agent_adapters::generate_ic_token_adapter(params)),
    ".agent.ic_token.status" => runtime
      .block_on(iron_cli::adapters::control::agent_adapters::get_ic_token_status_adapter(params)),
    ".agent.ic_token.regenerate" => runtime
      .block_on(iron_cli::adapters::control::agent_adapters::regenerate_ic_token_adapter(params)),
    ".agent.ic_token.revoke" => {
      runtime.block_on(iron_cli::adapters::control::agent_adapters::revoke_ic_token_adapter(params))
    }

    // Provider commands
    ".provider.list" => runtime
      .block_on(iron_cli::adapters::control::provider_adapters::list_providers_adapter(params)),
    ".provider.create" => runtime
      .block_on(iron_cli::adapters::control::provider_adapters::create_provider_adapter(params)),
    ".provider.get" => {
      runtime.block_on(iron_cli::adapters::control::provider_adapters::get_provider_adapter(params))
    }
    ".provider.update" => runtime
      .block_on(iron_cli::adapters::control::provider_adapters::update_provider_adapter(params)),
    ".provider.delete" => runtime
      .block_on(iron_cli::adapters::control::provider_adapters::delete_provider_adapter(params)),
    ".provider.assign_agents" => runtime
      .block_on(iron_cli::adapters::control::provider_adapters::assign_agents_adapter(params)),
    ".provider.list_agents" => runtime.block_on(
      iron_cli::adapters::control::provider_adapters::list_provider_agents_adapter(params),
    ),
    ...
    ".analytics.usage_by_agent" => runtime
      .block_on(iron_cli::adapters::control::analytics_adapters::usage_by_agent_adapter(params)),
    ".analytics.usage_by_provider" => runtime
      .block_on(iron_cli::adapters::control::analytics_adapters::usage_by_provider_adapter(params)),
    ".analytics.spending_by_period" => runtime.block_on(
      iron_cli::adapters::control::analytics_adapters::spending_by_period_adapter(params),
    ),
    ".analytics.export_usage" => runtime
      .block_on(iron_cli::adapters::control::analytics_adapters::export_usage_adapter(params)),
    ".analytics.export_spending" => runtime
      .block_on(iron_cli::adapters::control::analytics_adapters::export_spending_adapter(params)),

    // Budget limit commands
    ".budget_limit.get" => runtime.block_on(
      iron_cli::adapters::control::budget_limit_adapters::get_budget_limit_adapter(params),
    ),
    ".budget_limit.set" => runtime.block_on(
      iron_cli::adapters::control::budget_limit_adapters::set_budget_limit_adapter(params),
    ),

    // API token commands
    ".api_token.list" => runtime
      .block_on(iron_cli::adapters::control::api_token_adapters::list_api_tokens_adapter(params)),
    ".api_token.create" => runtime
      .block_on(iron_cli::adapters::control::api_token_adapters::create_api_token_adapter(params)),
    ".api_token.get" => runtime
      .block_on(iron_cli::adapters::control::api_token_adapters::get_api_token_adapter(params)),
    ".api_token.revoke" => runtime
      .block_on(iron_cli::adapters::control::api_token_adapters::revoke_api_token_adapter(params)),
    ...
    ".user.reset_password" => runtime
      .block_on(iron_cli::adapters::control::user_adapters::reset_user_password_adapter(params)),
    ".user.get_permissions" => runtime
      .block_on(iron_cli::adapters::control::user_adapters::get_user_permissions_adapter(params)),
