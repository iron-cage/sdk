...
pub async fn list_api_tokens_adapter(params: &HashMap<String, String>) -> Result<String, String> {
...
pub async fn create_api_token_adapter(params: &HashMap<String, String>) -> Result<String, String> {
...
pub async fn get_api_token_adapter(params: &HashMap<String, String>) -> Result<String, String> {
...
pub async fn revoke_api_token_adapter(params: &HashMap<String, String>) -> Result<String, String> {
