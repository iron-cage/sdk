...
**Cloud-level Hard Billing** - Billing per whole cloud project, not per service. Billing is also consumed by other cloud services, such as storage and networking.
