...
| **[architecture/](architecture/readme.md)** | 8 (001-008) + review | System architecture concepts (execution models, layers, service boundaries, data flow, integration, roles, entity model, runtime modes) |
...
| **[architecture/architecture_review_2026_03.md](architecture/architecture_review_2026_03.md)** | Full workspace audit, Rusticon promise gap analysis, 3-stage roadmap |
