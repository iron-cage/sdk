...
Thank you for contributing to Iron Runtime! This guide covers development setup, testing standards, and contribution workflows.
  ...
  "configurations": [
    {
      ...
      "cwd": "${workspaceFolder}",
      "preLaunchTask": "db-reset-seed"  // Fresh database before debug
    }
  ]
}
```
...
- **Module Documentation:** [module/*/readme.md](module/)
