...
| **llm_inference_providers_landscape.md** | Analyze LLM provider capabilities and pricing | Provider selection question → Provider comparison | OpenAI, Anthropic, Azure, Google analysis, capabilities, pricing, rate limits, budget controls, fallback strategy | NOT implementation (→ module/iron_lang/spec.md), NOT integration (→ docs/integration/llm_providers.md), NOT capability (→ docs/capabilities/llm_access_control.md) |
